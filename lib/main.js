...
var notificationPanelURL = "https://twitter.com/i/notifications";
var notificationPanel = Panel({
  contentURL        : notificationPanelURL,
  height            : 500,
  width             : 400,
...
function handleButtonStateChange(state) {
  if (state.checked) {
    ...
    notificationPanel.port.emit("ensure-page-url", notificationPanelURL);
  }
}
